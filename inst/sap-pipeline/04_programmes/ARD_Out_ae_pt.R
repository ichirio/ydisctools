...
# Programme:    Generate code to produce ARD for Out_ae_pt
# Output:       Summary of Treatment-Emergent Adverse Events by Preferred Term
...
if(nrow(df2_An_20) != 0){
df3_An_20 <- df3_An_20 |>
        dplyr::mutate(AnalysisId = 'An_20',
               MethodId = 'Mth_total_n',
               OutputId = 'Out_ae_pt')
} else {
    df3_An_20 = data.frame(AnalysisId = 'An_20',
               MethodId = 'Mth_total_n',
               OutputId = 'Out_ae_pt')
}
    df3_An_20 <- df3_An_20 |>
...
if(nrow(df2_An_21) != 0){
df3_An_21 <- df3_An_21 |>
        dplyr::mutate(AnalysisId = 'An_21',
               MethodId = 'Mth_categorical_summary',
               OutputId = 'Out_ae_pt')
} else {
    df3_An_21 = data.frame(AnalysisId = 'An_21',
               MethodId = 'Mth_categorical_summary',
               OutputId = 'Out_ae_pt')
}
    df3_An_21 <- df3_An_21 |>
...
if(nrow(df2_An_22) != 0){
df3_An_22 <- df3_An_22 |>
        dplyr::mutate(AnalysisId = 'An_22',
               MethodId = 'Mth_categorical_summary',
               OutputId = 'Out_ae_pt')
} else {
    df3_An_22 = data.frame(AnalysisId = 'An_22',
               MethodId = 'Mth_categorical_summary',
               OutputId = 'Out_ae_pt')
}
    if(nrow(df2_An_22) != 0){
