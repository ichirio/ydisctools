...
# Programme:    Generate code to produce ARD for Out_ae_sev
# Output:       Summary of Treatment-Emergent Adverse Events by Maximum Severity
...
if(nrow(df2_An_23) != 0){
df3_An_23 <- df3_An_23 |>
        dplyr::mutate(AnalysisId = 'An_23',
               MethodId = 'Mth_total_n',
               OutputId = 'Out_ae_sev')
} else {
    df3_An_23 = data.frame(AnalysisId = 'An_23',
               MethodId = 'Mth_total_n',
               OutputId = 'Out_ae_sev')
}
    df3_An_23 <- df3_An_23 |>
...
if(nrow(df2_An_24) != 0){
df3_An_24 <- df3_An_24 |>
        dplyr::mutate(AnalysisId = 'An_24',
               MethodId = 'Mth_categorical_summary_flat',
               OutputId = 'Out_ae_sev')
} else {
    df3_An_24 = data.frame(AnalysisId = 'An_24',
               MethodId = 'Mth_categorical_summary_flat',
               OutputId = 'Out_ae_sev')
}
    if(nrow(df2_An_24) != 0){
...
if(nrow(df2_An_25) != 0){
df3_An_25 <- df3_An_25 |>
        dplyr::mutate(AnalysisId = 'An_25',
               MethodId = 'Mth_categorical_summary',
               OutputId = 'Out_ae_sev')
} else {
    df3_An_25 = data.frame(AnalysisId = 'An_25',
               MethodId = 'Mth_categorical_summary',
               OutputId = 'Out_ae_sev')
}
    if(nrow(df2_An_25) != 0){
